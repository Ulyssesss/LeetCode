...
public class _0128 {
    ...
    public static void main(String[] args) {
        System.out.println(new _0128().longestConsecutive(new int[] {100, 4, 200, 1, 3, 2}));
        System.out.println(new _0128().longestConsecutive(new int[] {1,2,0,1}));
        System.out.println(new _0128().longestConsecutive(new int[] {0,3,7,2,5,8,4,6,0,1}));
    }
